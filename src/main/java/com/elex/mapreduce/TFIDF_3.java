		...
		public void map(Object key, Text value, Context context)
			...
			while (userWords.hasMoreTokens()) {
				...
				while (userWordsFrag.hasMoreTokens()) {
					String wordTFtmps = userWordsFrag.nextToken();
					StringTokenizer wordTFtmp = new StringTokenizer(wordTFtmps, ",");
					while(wordTFtmp.hasMoreTokens()){
						//String wordTFs = wordTFtmp.nextToken();
						StringTokenizer wordTF = new StringTokenizer(wordTFtmp.nextToken(), " ");
...
//			Text outputValue = new Text();
			while (userIter.hasNext()) {
				...
				float tfidf = tf * idf;
//				String ouputTmp = user + "\t" + idf + "\t" + tfidf + ",";
//				StringBuffer outputTmp = new StringBuffer();
//				outputTmp.append(user);
//				outputTmp.append("");
//				outputTmp.append(tfidf);
//				outputTmp.append(",");
				String outputTmp = user + " " + tfidf + ",";
//				byte []bytes = outputTmp.toString().getBytes();
//				outputValue.append(bytes, 0, bytes.length);
				Text outputValue = new Text();
...
//		tfJob.setJarByClass(TFIDF_3.class);
...
//		userCountJob.setJarByClass(TFIDF_3.class);
...
//		userCountJob.waitForCompletion(true);
		...
		idfJob.setJarByClass(TFIDF_3.class);
